...
# Keep output in memory so we can call summary() and plot()
save_output <- FALSE
...
##########################################################
#### Run matching pipeline and keep result in memory  ####
##########################################################
...
##################################################
#### Use summary() and plot() on the result   ####
##################################################

# Calls summary.matching_study_cohort()
summary_out <- summary(result)

# Calls plot.matching_study_cohort(); default by_var = "T0"
plot(result)

# Example with another axis variable
